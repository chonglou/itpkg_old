...
public class AdminController {
    ...
    @RequestMapping(value = "/captchaFM", method = RequestMethod.GET)
    @ResponseBody
    Form getCaptchaForm() {
        ...
        Form fm = new Form("captcha", "验证码设置", "/admin/captchaFM");
    ...
    @RequestMapping(value = "/captchaFM", method = RequestMethod.POST)
    @ResponseBody
